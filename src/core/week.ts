/** Rolling last-7-days desk window. `weekId` is an ISO week label, not rank expiry. Monday 00:00 UTC is not the drop. */
...
/** Inclusive length of the public week window. Not a Monday midnight bucket. Not a 24h lock on #1. */
