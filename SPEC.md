...
The board header shows the current `weekId` label and the rolling last-7-days window. Occupied prize chrome (kicker, #1 heading, later-pack) names that rolling window, not a calendar week. Empty week stays Claim #1 / No paid brief.
