...
The board header shows the rolling last-7-days window. Occupied prize chrome (kicker, #1 heading, later-pack) names that rolling window, not a calendar week. Occupied mast period-meta follows last-7-days, not ISO `weekId`. Occupied mast window-since names last-7-days, not an ISO `startsAt` timestamp. Empty mast period-meta follows last-7-days, not ISO `weekId`. Empty mast window-since names last-7-days, not an ISO `startsAt` timestamp. Empty prize chrome (kicker, #1 heading, empty-board copy) names that rolling window, not a calendar week. Document chrome (title and meta) names that rolling window, not a calendar week. About copy (meta and lead) names that rolling window, not a weekly auction. Empty week stays Claim #1 / No paid brief.
